...
(function($, document, undefined) {
	...
	var PullRefresh = {
		...
		_setCaption: function(title, reset) {
			...
			var self = this;
			if (pocket) {loading.style.backgroundImage='url(../../imgs/shouye_shuaxinxiala@2x.png)';
								loading.style.backgroundSize='contain';
				if (reset) {
					setTimeout(function() {
					...
					if (title !== this.lastTitle) {
						...
						if (isPulldown) {
							if (title === options.down.contentrefresh) {
								//loading.className = CLASS_LOADING;
								loading.style.backgroundImage='url(../../imgs/shouye_shuaxinjiazaizhong@2x.png)';
								loading.style.backgroundSize='contain';
